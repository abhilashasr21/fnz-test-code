...
locals {
  ...
  private-zones-mapping-data = jsondecode(file("${path.module}/private-zones.json"))
...
resource "azurerm_resource_group" "resource_group_dns" {
  name     = var.resource_group_dns_name
...
resource "azurerm_user_assigned_identity" "user_assigned_identity" {
  location            = azurerm_resource_group.resource_group_dns.location

...
child_management_groups = {
  tenant_mg = { name = "48d31bc6-3359-4e9d-af8b-75b9b41ebd66", display_name = "Tenant Management Group" }
  ...
  mg401 = { name = "mg401", display_name = "Child 401" }
  mg402 = { name = "mg402", display_name = "Child 402" }
  mg403 = { name = "mg403", display_name = "Child 403" }
}